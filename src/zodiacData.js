...
export const zodiacSigns = [
  {
    ...
    strengths: ["Liderazgo", "Energía", "Determinación", "Valentía"],
    weaknesses: ["Impulsivo", "Impaciente", "Agresivo", "Egoísta"],
  ...
  },
  {
    ...
    strengths: ["Estabilidad", "Paciencia", "Confiabilidad", "Sensualidad"],
    weaknesses: ["Terco", "Posesivo", "Perezoso", "Materialista"],
  ...
  },
  {
    ...
    strengths: ["Versatilidad", "Comunicación", "Inteligencia", "Humor"],
    weaknesses: ["Superficial", "Indeciso", "Ansioso", "Inconsistente"],
  ...
  },
  {
    ...
    strengths: ["Empatía", "Intuición", "Lealtad", "Protección"],
    weaknesses: ["Malhumorado", "Pesimista", "Manipulador", "Inseguro"],
  ...
  },
  {
    ...
    strengths: ["Liderazgo", "Creatividad", "Generosidad", "Confianza"],
    weaknesses: ["Arrogante", "Egoísta", "Dominante", "Perezoso"],
  ...
  },
  {
    ...
    strengths: ["Organización", "Análisis", "Trabajo duro", "Praticidad"],
    weaknesses: ["Crítico", "Preocupón", "Timidez", "Perfeccionismo"],
  ...
  },
  {
    ...
    strengths: ["Diplomacia", "Justicia", "Cooperación", "Encanto"],
    weaknesses: ["Indeciso", "Evita confrontación", "Superficial", "Autocompasión"],
  ...
  },
  {
    ...
    strengths: ["Determinación", "Valentía", "Honestidad", "Lealtad"],
    weaknesses: ["Celoso", "Resentido", "Secreto", "Violento"],
  ...
  },
  {
    ...
    strengths: ["Generosidad", "Idealismo", "Sentido del humor", "Libertad"],
    weaknesses: ["Impaciente", "Irresponsable", "Superficial", "Filosofar demasiado"],
  ...
  },
  {
    ...
    strengths: ["Responsabilidad", "Disciplina", "Auto-control", "Gestión"],
    weaknesses: ["Sabelotodo", "Rencoroso", "Pesimista", "Condescendiente"],
  ...
  },
  {
    ...
    strengths: ["Progresista", "Original", "Independiente", "Humanitario"],
    weaknesses: ["Temperamental", "Intransigente", "Distante", "Sin compromiso"],
    compatibility: ["Géminis", "Libra", "Sagitario", "Aries"],
    image: "🏺",
    symbol: "♒",
  ...
  },
  {
    ...
    strengths: ["Compasión", "Artístico", "Intuitivo", "Gentil"],
    weaknesses: ["Temeroso", "Demasiado confiado", "Tristeza", "Escapar de la realidad"],
